...
def resnet18(cfg, **kwargs):
    ...
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], cfg, **kwargs)
    return model
...
def resnet34(cfg, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], cfg, **kwargs)
    return model
...
def resnet101(cfg, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], cfg, **kwargs)
    return model
...
def resnet152(cfg, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 8, 36, 3], cfg, **kwargs)
    return model
