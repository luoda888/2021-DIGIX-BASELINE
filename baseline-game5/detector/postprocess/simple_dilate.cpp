...
namespace post_process{
                                      ...
                                      int min_border=3)
    {
        ...
        for(const auto &poly : polys)
        {
            ...
            if(min(poly_h, poly_w) < min_border) { continue; }
            ...
            if (count < min_area_thr) { continue; }
            else { avg_score /= count; }
            if (avg_score < score_thr) { continue; }
            ...
            if (solution.size() == 0 || solution.size() > 1) { continue; }
            ...
            // smooth polygon
//            auto points_num = dilated_poly.size();
//            if(points_num > 72)
//            {
//                int sample_dilation = static_cast<int>(ceil(points_num * 1.0 / 72.0));
//                vector<int> smooth_dilated_poly;
//                for(int i = 0;i < points_num; i += sample_dilation)
//                {
//                    smooth_dilated_poly.push_back(dilated_poly[2 * i]);
//                    smooth_dilated_poly.push_back(dilated_poly[2 * i + 1]);
//                }
//
//                dilated_bboxs.push_back(get_bbox(smooth_dilated_poly, score_h, score_w));
//                dilated_polys.push_back(smooth_dilated_poly);
//            }
//            else
//            {
//                dilated_bboxs.push_back(get_bbox(dilated_poly, score_h, score_w));
//                dilated_polys.push_back(dilated_poly);
//            }
        }
